    ...
    public void whenCast(VectorSkillResult result, SkillMetadata skillMeta) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                MMOItems.plugin.getEntities().registerCustomEntity(shulkerBullet, new ShulkerMissileEntityData(skillMeta.getCaster(), new DamageMetadata(skillMeta.getParameter("damage"), DamageType.SKILL, DamageType.MAGIC), skillMeta.getParameter("effect-duration"), null));
